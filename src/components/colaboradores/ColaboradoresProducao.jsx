...
export default function ColaboradoresProducao() {
  ...
  const filtradas = producoes.filter(p => p.data === filtroData);
    ...
    <div className="space-y-4 pt-4">
      <div className="flex flex-wrap gap-3 items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          {filtradas.length > 0 && <span className="text-sm text-muted-foreground">Total: <strong>{total.toLocaleString('pt-BR')}</strong></span>}
        </div>
